...
const projectCard = ({name='Project Name',desc='',image, website}) => {
  ...
  return (
    <div className='justify-center flex cursor-pointer' onClick={()=>HandleClick()}>
      ...
      <div className=' card-animation w-[100%] h-[100%] absolute bg-amber-400 opacity-70 absolute top-[100%] backdrop-filter backdrop-blur-lg  shadow-lg z-10 flex flex-col justify-center gap-4 items-center p-4'>
